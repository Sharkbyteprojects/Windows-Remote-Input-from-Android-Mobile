...
#define pathforfile ".\.bin\binary build\"
...
OutputDir=.\.bin
OutputBaseFilename=serversetup_bin
...
[Files]
Source: "{#pathforfile}{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#pathforfile}*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
